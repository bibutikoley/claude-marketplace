...
- Claude Code CLI: just run `claude mcp add apple-notes-mcp -s user -- uvx --from "git+https://github.com/bibutikoley/claude-marketplace@v0.5.1#subdirectory=plugins/apple-notes-mcp" apple-notes-mcp`, then skip to Step 6.
...
- opencode form (merge under top-level "mcp"):
  {"mcp": {"apple-notes-mcp": {"type": "local", "command": ["uvx", "--from", "git+https://github.com/bibutikoley/claude-marketplace@v0.5.1#subdirectory=plugins/apple-notes-mcp", "apple-notes-mcp"]}}}
